...
export function PageHeader({ eyebrow, title, description, imageUrl, imagePosition }: Props) {
  return (
    <section className="relative overflow-hidden bg-brand-ink">
      ...
      {!imageUrl && <div className="absolute inset-0 bg-gradient-to-br from-brand-forest-dark via-brand-ink to-brand-ink" />}
